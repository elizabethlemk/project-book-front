  ...
  render(){
    ...
    if (localStorage.token) {
      loginOptions =
        <Menu.Menu position='right'>
          ...
          <Dropdown item text={username !== 'undefined' ? username : null} active={(activeItem === 'user').toString()} onClick={this.handleItemClick}>
            <Dropdown.Menu>
    ...
    return (
      <Menu color='olive'>
        ...
        <Menu.Menu position='right'>
          <Header as='h1' className='middle'> Project Book </Header>
        </Menu.Menu>
        {loginOptions}
      </Menu>
    )
